...
function ReportsManagementPage() {
  ...
  const selected = (data?.reports || []).find((report) => report.id === selectedId) || (data?.reports || [])[0] || null
  ...
  if (!selected) return <ManagerLayout><div className="reports-loading">No reports available.</div></ManagerLayout>
