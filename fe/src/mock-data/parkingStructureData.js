export const parkingStructureData = {
  ...
  zones: [
    { location: 'Basement', zone: 'Zone A', type: 'Motorcycle', capacity: 120, occupied: 82, available: 31, reserved: 7, maintenance: 0, status: 'Normal' },
    ...
    { location: 'Floor 3', zone: 'Zone C', type: 'EV Charging', capacity: 80, occupied: 30, available: 30, reserved: 7, maintenance: 13, status: 'Maintenance' },
    { location: 'Floor 3', zone: 'Zone D', type: 'Reserved / VIP', capacity: 40, occupied: 11, available: 17, reserved: 12, maintenance: 0, status: 'Normal' },
  ],
  slotTypes: [
    { type: 'Motorcycle', total: 120, occupied: 82, available: 31, status: 'Normal' },
    { type: 'Car Parking', total: 284, occupied: 220, available: 45, status: 'High Occupancy' },
    { type: 'EV Charging', total: 80, occupied: 30, available: 30, status: 'Maintenance' },
    { type: 'Reserved / VIP', total: 40, occupied: 11, available: 17, status: 'Normal' },
  ],
  recentUpdates: [
