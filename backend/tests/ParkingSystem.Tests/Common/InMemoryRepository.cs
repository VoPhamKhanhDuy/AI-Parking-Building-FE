...
/// <summary>No-op ISystemLogService for tests that don't care about audit logging.</summary>
public sealed class NullSystemLogService : ISystemLogService
{
    public Task LogAsync(SystemLog? entry, CancellationToken cancellationToken = default)
        => Task.CompletedTask;
}

/// <summary>In-memory TimeProvider for deterministic test time.</summary>
