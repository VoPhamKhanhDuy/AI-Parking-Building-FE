...
public class PaymentServiceTests
{
        ...
        Build()
    {
        ...
        var svc = new PaymentService(payments, sessions, users, uow, clock);
    ...
    public async Task WaiveAsync_pending_payment_becomes_waived_with_reason()
    {
        ...
        var dto = await svc.WaiveAsync(p.Id, "VIP guest");
    ...
    public async Task WaiveAsync_paid_payment_appends_reason_to_existing_reference()
    {
        ...
        var dto = await svc.WaiveAsync(p.Id, "goodwill");
    ...
    public async Task WaiveAsync_rejects_refunded_payment()
    {
        ...
        await Assert.ThrowsAsync<ValidationException>(() => svc.WaiveAsync(p.Id, null));
    }
