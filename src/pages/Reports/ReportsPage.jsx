    ...
    <MainLayout>
      <div className="reports-page">
        ...
        <div className="reports-main-grid">
          ...
          <aside className="reports-metadata-card">
            <div className="metadata-top">
              <div>
                <p className="meta-label">Selected Report Metadata</p>
                <h2>{detail.metadata.reportName}</h2>
              </div>
              <div className="meta-status">{detail.metadata.status}</div>
            </div>

            <div className="metadata-grid">
              <div><span>Selected Report</span><strong>{detail.metadata.reportName}</strong></div>
              <div><span>Date Range</span><strong>{detail.metadata.dateRange}</strong></div>
              <div><span>Building</span><strong>{detail.metadata.building}</strong></div>
              <div><span>Generated By</span><strong>{detail.metadata.generatedBy}</strong></div>
              <div><span>Generated At</span><strong>{detail.metadata.generatedAt}</strong></div>
              <div><span>Status</span><strong>{detail.metadata.status}</strong></div>
            </div>
