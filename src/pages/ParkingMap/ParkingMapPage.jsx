...
function ParkingMapPage() {
  ...
  const isManager = window.location.pathname.includes('/manager') || true
  const Layout = isManager ? ManagerLayout : MainLayout
  const dashboardPath = isManager ? ROUTE_PATHS.managerDashboard : ROUTE_PATHS.dashboard
